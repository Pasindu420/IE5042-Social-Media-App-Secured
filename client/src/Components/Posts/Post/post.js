...
import ThumbUpOffAltIcon from '@mui/icons-material/ThumbUpOffAlt'; // Ensure @mui/icons-material is installed
...
const Post = ({ post, setCurrentid }) => {
    ...
    return (
        <Card className={classes.card} elevation={6} raised>
            ...
            <CardContent>
                {/* Updated: This now displays the full message securely to prevent XSS */}
